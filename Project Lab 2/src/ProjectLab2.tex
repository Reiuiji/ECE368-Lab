...
For the interrupt controller you should design and build a controller that will monitor the change in state of various inputs. The change in state will be up to you. For example you can design a interrupt that will monitor the change in state and will go high if their is a change.
